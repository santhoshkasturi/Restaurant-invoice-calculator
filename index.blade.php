...
<head>
    ...
    <!-- The above CSS and Bootstrap bundles are taken from the https://getbootstrap.com/docs/5.0/getting-started/introduction/ -->

</head>
<body>
<nav class="navbar navbar-dark bg-dark">

    <span class="navbar-brand mb-0 h1">Elite Restaurant</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="container">
                        <div class="list-group-item list-group-tem-action active">Ingredients</div>
